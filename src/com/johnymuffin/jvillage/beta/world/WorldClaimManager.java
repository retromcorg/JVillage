...
////        }
//        for (VClaim vClaim : claims) {
//            if (vClaim.getWorldName().equals(vChunk.getWorldName()) && vClaim.getX() == vChunk.getX() && vClaim.getZ() == vChunk.getZ()) {
//                village = jVillage.getVillageMap().getVillage(vClaim.getVillage());
//                break;
//            }
//        }
...
//    }
//
//    public void removeClaimsByVillage(Village village) {
//        Iterator<VClaim> iterator = claims.iterator();
//        while (iterator.hasNext()) {
//            VClaim vClaim = iterator.next();
//            if (vClaim.getVillage().equals(village.getTownUUID())) {
//                iterator.remove();
//            }
//        }
//
