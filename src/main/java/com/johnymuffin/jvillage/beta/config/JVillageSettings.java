...
//        generateConfigOption("settings.town-claim.maximum-claim-size.circle.info", "The maximum chunk radius of a circle claiming permitted.");
        ...
        generateConfigOption("settings.economy.type", "fundamentals");
        generateConfigOption("settings.economy.type.info", "Economy type: 'fundamentals' for Fundamentals economy plugin, or 'item' for item-based currency.");
        
        generateConfigOption("settings.economy.item-currency.material", "IRON_INGOT");
        generateConfigOption("settings.economy.item-currency.info", "The item type to use as currency when economy type is 'item'. Valid materials: IRON_INGOT, GOLD_INGOT, DIAMOND, etc.");
